function [plotData1_sx,plotData1_sy,plotData2_sx,plotData2_sy,plotData3,plotData4] = Data_generate_stateAsymHill(mdata,matdata)
% mdata 模型参数
% matdata 材料参数
...
function [sig_bar] = effect_stress(matdata,mdata,sig,sigT00,yieldType)
    sig_bar=effstress_of_StateAsymHill(matdata,mdata,sig,0);
end
