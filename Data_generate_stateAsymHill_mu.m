function [plotData1_sx,plotData1_sy,plotData2_sx,plotData2_sy,plotData3,plotData4] = Data_generate_stateAsymHill_mu(mdata,matdata,mu)
% mdata 模型参数
% matdata 材料参数

yieldFunctionType=mu;
...
function [sig_bar] = effect_stress(matdata,mdata,sig,sigT00,yieldType)
    ...
    sig_bar=effstress_of_StateAsymHill_mu(matdata,mdata,sig,yieldType);

%     sig_bar=effstress_of_StateAsymHill_New(matdata,mdata,sig,0);
end
