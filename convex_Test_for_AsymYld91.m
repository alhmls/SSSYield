function [convex] = convex_Test_for_AsymYld91(Matdata,sigref,yieldType)
...
for i=1:length(poleAngle)
    ...
    sig.yy=sin(angle);
    sig.xy=0;
    dnom=effect_stress_of_asymYld91(Matdata,sig,m);
    xnom=Matdata.Txy00/dnom;
    sx(i)=sig.xx*xnom;
    sy(i)=sig.yy*xnom;
    sz(i)=0.0;
end

plot3(utsigxx,utsigyy,utsigxy,'.','color','g');
plot3(ucsigxx,ucsigyy,ucsigxy,'.','color','b');
plot3(sx,sy,sz,'.','color','r');
 
% plot3(Matdata.Txy00,0,0,'.','color','g','markersize',25);
% plot3(0,Matdata.Txy90,0,'.','color','g','markersize',25);
% plot3(Matdata.Txy45/2,Matdata.Txy45/2,Matdata.Txy45/2,'.','color','g','markersize',25);
% plot3(-Matdata.Cxy00,0,0,'.','color','b','markersize',25);
% plot3(0,-Matdata.Cxy90,0,'.','color','b','markersize',25);
% plot3(-Matdata.Cxy45/2,-Matdata.Cxy45/2,Matdata.Cxy45/2,'.','color','b','markersize',25);
% plot3(Matdata.TEB,Matdata.TEB,0.0,'.','color','r','markersize',25);
% plot3(-Matdata.CEB,-Matdata.CEB,0.0,'.','color','r','markersize',25);
% plot3(Matdata.TPS00X,Matdata.TPS00X/2,0.0,'.','color','k','markersize',25)
% plot3(Matdata.TPS90Y/2,Matdata.TPS90Y,0.0,'.','color','k','markersize',25)
