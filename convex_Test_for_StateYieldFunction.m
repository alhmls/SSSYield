function [convex] = convex_Test_for_StateYieldFunction(Matdata,sigref,yieldType)
...
[mdata]=cal_mdata_Hou2023(MatData,5);
if m==1
...
elseif m==-7
    sigbar=effstress_of_StateAsymHill_New(MatData,mdata,sig,0);
else
